...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_ HRESULT DirectX::ComputeNormals(const uint16_t* indices, size_t nFaces, const XMFLOAT3* positions, size_t nVerts, CNORM_FLAGS flags, XMFLOAT3* normals) noexcept {
...
_Use_decl_annotations_ HRESULT DirectX::ComputeNormals(const uint32_t* indices, size_t nFaces, const XMFLOAT3* positions, size_t nVerts, CNORM_FLAGS flags, XMFLOAT3* normals) noexcept {
    if (!indices || !positions || !nFaces || !nVerts || !normals)
        return E_INVALIDARG;
